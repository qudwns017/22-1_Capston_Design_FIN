...
export default function MapContainer() {
  ...
  // 마커를 클릭했을 때 마커 위에 표시할 인포윈도우를 생성합니다
  var iwContent1 =
      '<div class="box"><ul><li><h4>장소 이름 :</h4> <h3>중부대학교</h3></li><li><h4>주소 :</h4> <h3>경기 고양시 덕양구 대자동 1286</h3></li></ul><a href="/reservation" class="check">예약하기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
    iwRemoveable = true; // removeable 속성을 ture 로 설정하면 인포윈도우를 닫을 수 있는 x버튼이 표시됩니다
  // 마커를 클릭했을 때 마커 위에 표시할 인포윈도우를 생성합니다
  var iwContent2 =
      '<div class="box"><ul><li>주차장 이름 :</li><li>주소 :</li><li>시간 당 가격 :</li></ul><a href="/reservation" class="check">예약하기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
